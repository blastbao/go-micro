...
// source: github.com/blastbao/go-micro/server/proto/server.proto
...
func init() {
	proto.RegisterFile("github.com/blastbao/go-micro/server/proto/server.proto", fileDescriptor_4cb0c66620400ff8)
}
